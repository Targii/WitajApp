...
public class navi extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TextView wypiszImie = (TextView) findViewById(R.id.textView);
        //wypiszImie.setText("Witaj, " + FirstName + " " + LastName);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent();
            i.setClass(getApplicationContext(), SettingPref.class);
            startActivity(i);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((navi) activity).onSectionAttached(
