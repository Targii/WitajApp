...
public abstract class HeaderFooterRecyclerViewAdapter<H extends RecyclerView.ViewHolder, C extends RecyclerView.ViewHolder, F extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public final void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (headerItemCount > 0 && position < headerItemCount) {
            onBindHeaderItemViewHolder((H) viewHolder, position);
        } else if (contentItemCount > 0 && position - headerItemCount < contentItemCount) {
            onBindContentItemViewHolder((C)viewHolder, position - headerItemCount);
        } else {
            onBindFooterItemViewHolder((F)viewHolder, position - headerItemCount - contentItemCount);
        }
    }
     ...
     */
    protected abstract H onCreateHeaderItemViewHolder(ViewGroup parent, int headerViewType);
     ...
     * @return the view holder.
     */
    protected  F onCreateFooterItemViewHolder(ViewGroup parent, int footerViewType) {
        return null;
    }
     ...
     * @return the view holder.
     */
    protected abstract C onCreateContentItemViewHolder(ViewGroup parent, int contentViewType);
     ...
     * @param position         the position.
     */
    protected abstract void onBindHeaderItemViewHolder(H headerViewHolder, int position);
     ...
     * @param position         the position.
     */
    protected void onBindFooterItemViewHolder(F footerViewHolder, int position) {
     ...
     * @param position          the position.
     */
    protected abstract void onBindContentItemViewHolder(C contentViewHolder, int position);
